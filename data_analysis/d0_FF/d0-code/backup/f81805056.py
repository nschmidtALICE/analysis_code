...
class filterObject():
    ...
    def filter(self):
        ...
        v_tagdR            = array.array('f',[0])
        v_tagMass          = array.array('f',[0])
        v_tagPt            = array.array('f',[0])
        v_tagEta           = array.array('f',[0])
        v_tag_idx_jet      = array.array('f',[0])
        v_tag_lifet        = array.array('f',[0])
        v_tag_lifetWrongPV = array.array('f',[0])
        v_tagnRnd          = array.array('f',[0])
        v_tag_decVtxChi2  = array.array('f',[0])
        v_tag_logdecVtxChi2  = array.array('f',[0])

        v_jetnTComb     = array.array('f',[0])
        v_jetnTUnique   = array.array('f',[0])
        v_jetnConst     = array.array('f',[0])
        v_jetPt         = array.array('f',[0])
        v_jetEta        = array.array('f',[0])
        v_tagZ          = array.array('f',[0])
        v_D0Z           = array.array('f',[0])  # Change from v_JPsiZ
        v_mpipi         = array.array('f',[0])
        v_QValue        = array.array('f',[0])
        v_EffWeight     = array.array('f',[0])
        v_EffWeight_0   = array.array('f',[0])
        v_EffWeight_1   = array.array('f',[0])
        v_EffWeight_2   = array.array('f',[0])
        v_EffWeight_3   = array.array('f',[0])
        v_EffWeight_4   = array.array('f',[0])
        v_EffWeight_5   = array.array('f',[0])
        ...
        v_piPTrckChi2   = array.array('f',[0])
        v_piPprobNNpi   = array.array('f',[0])
        v_piPprobGhost  = array.array('f',[0])
        v_piMTrckChi2   = array.array('f',[0])
        v_piMprobNNpi   = array.array('f',[0])
        v_piMprobGhost  = array.array('f',[0])
        v_decayVtxChi2  = array.array('f',[0])
        v_Dist1         = array.array('f',[0])
        v_Dist2         = array.array('f',[0])
        v_Dist3         = array.array('f',[0])
        v_mD0           = array.array('f',[0])  # Change from v_mJPsi
        v_nSPD          = array.array('f',[0])
        v_isPrimary2    = array.array('f',[0])
        v_KprobNNK     = array.array('f',[0])
        v_KprobGhost   = array.array('f',[0])
        v_KTrckChi2    = array.array('f',[0])
    ...
    def getD0EffCorrWeight(self, kaonVector, pionVector, type=-1):
        # Similar to getEffCorrWeight but for D0 → K pi
        ...
        # Calculate appropriate weights based on type
        # ...
