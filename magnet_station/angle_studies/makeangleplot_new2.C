...
void makeangleplot_new2(TString inputfile = "/home/niviths/Downloads/magnetStationSims/minimumBias_MS_MagDown_500plus.root") //tilt
// void makeangleplot_new2(TString inputfile = "/home/niviths/Downloads/magnetStationSims/minimumBias_MS_MagDown_600plus.root") //vertical
{
    ...
    float add_rotations[nModules] = {0.7, 0.7, 0.7, 0.8, 0.9, 1.0, 1.0};
